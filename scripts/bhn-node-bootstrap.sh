#!/bin/bash
# ╔══════════════════════════════════════════════════════════╗
# ║    BLACKHOLE NETWORK (BHN) — NODE BOOTSTRAP SCRIPT v3    ║
# ║   Auto-configures any new VPS into the BHN network       ║
# ║   Includes all security hardening from production        ║
# ╚══════════════════════════════════════════════════════════╝
#
# Usage: bash bhn-node-bootstrap.sh <NODE_NAME> <NODE_IP> <WG_INTERFACE>
# Example: bash bhn-node-bootstrap.sh BHN-VPS-NYC-US2 123.456.789.0 wg2
#
...
[[ -z "$NODE_IP" ]] && err "Usage: bash bhn-node-bootstrap.sh <NODE_NAME> <NODE_IP> <WG_INTERFACE>"
