...
SEED = [
    ...
    },
    {
        ...
        "content": (
            ...
            "Frankfurt exit (public 192.248.187.208, tunnel 10.9.0.2, wg1) is exit-only — "
            "no application services. Clients: FLETCH-DESKTOP at 10.8.0.4 and "
            "FLETCH-PHONE at 10.8.0.2, each with split (admin) + full (privacy) "
