#!/bin/bash
# ╔══════════════════════════════════════════════════════════╗
# ║       EVENTHORIZON — NODE BOOTSTRAP SCRIPT v4            ║
# ║   Three-phase orchestrator: open → install → lockdown    ║
# ╚══════════════════════════════════════════════════════════╝
#
# Usage:
#   bash eh-node-bootstrap.sh <NAME> <IP> <WG_INTERFACE> <TYPE> <REGION>
#
# Example:
#   bash eh-node-bootstrap.sh EH-VPS-NYC-US2 1.2.3.4 wg2 exit US-EAST
#
...
usage() {
  cat <<EOF
Usage: bash eh-node-bootstrap.sh <NAME> <IP> <WG_INTERFACE> <TYPE> <REGION>

  NAME          e.g. EH-VPS-NYC-US2
...
# Auto-generated by eh-node-bootstrap.sh v${BOOTSTRAP_VERSION} — DO NOT EDIT
NODE_NAME=${NODE_NAME}
NODE_TYPE=${NODE_TYPE}
