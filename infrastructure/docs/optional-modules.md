...
| **Tor** (bridge/relay, non-exit) ✅ scheduled (2026-05-11) | Privacy-routing layer for Frankfurt. Run as a **bridge or middle relay**, NOT as an exit (keeps legal exposure minimal). SearXNG can route upstream via this Tor circuit for unlinkable search; future use as obfuscation layer for HORIZON-initiated outbound queries possible. | [gitlab.torproject.org/tpo/core/tor](https://gitlab.torproject.org/tpo/core/tor) | BSD-3-Clause | **Frankfurt** (privacy node) |
